...
%% Mapping Technique : Nearest Integer 
...
%% variable used during the calcul ----------------------------------------
     ...
     fitness_best = 0;
     %%%% save the contnious coded population 
     population = [];
     %%%% save the previous contnious coded population 
     populationsave = []; 
     %%%% save the binary coded population 
     population_bin = [];
     %%%% save the previous binary coded population      
     population_bin_save = [];          
...
fit_new = [];    
%% ------- memorize the previous state of the binary and contnious coded population   ---------
