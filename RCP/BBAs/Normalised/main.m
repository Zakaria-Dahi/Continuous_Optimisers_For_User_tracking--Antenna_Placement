...
%% Mapping Technique : Normalisation
...
%% variable used during the calcul ----------------------------------------
     ...
     %%%% save the continuous coded population before normalisation 
     population_norm = [];
     %%%%% Save the previous state of the binary population 
     populationsave = [];
     %%%%% Save the previous state of the continuous population 
     populationsave_norm = [];            
%% ------------ Generate the intial population ------------------
population_norm = GeneratePopulation(indiv,Dimension);
...
fit_new = [];
%% ------- memorize the previous state of the continuous population  --------
populationsave_norm = population_norm;
%% ------- memorize the previous state of the binary population  --------
...
%% ----- If new solutions are better, update them in   the population ------
           if  (fit_new(w) > fit(w)) || (isequal(num2str(fit_new(w)),'NaN') == 1)
               population_norm(w,:) = populationsave_norm(w,:);
